...
function toEditAppConfig(a: AppConfig) {
  return {
    ...
    managerPhoneNum:
      a.managerPhoneNum.trim() == "" ? [] : a.managerPhoneNum.split(","),
...
export default function AdminSettingsPage(P: AdminSettingsProps) {
  const [appSetting, setAppSetting] = useState<EditAppConfig>(
    toEditAppConfig(P.appSetting)
  )
  ...
  return (
    <AdminPagesContainer currentPage="settings">
      <Head>
        <title>تنظیمات</title>
      </Head>
        ...
        >
          <Row className="align-items-center">
            ...
            <SettingItem
              ...
              onSet={(e) =>
                setAppSetting((i) => ({ ...i, daysBeforeDayToReserve: e }))
              }
            />

            <SettingItem
              label="لغو تا چند روز قبل ممکن است"
              isNum
              value={appSetting.dayBeforeDayToCancel}
              onSet={(e) =>
                setAppSetting((i) => ({ ...i, dayBeforeDayToCancel: e }))
              }
            />

            <SettingItem
              label="کد تجاری درگاه پرداخت"
              value={appSetting.paymentPortalMerchantId}
              onSet={(e) =>
                setAppSetting((i) => ({ ...i, paymentPortalMerchantId: e }))
              }
            />

            <SettingItemCheck
              label="برنامه در حالت تست (پرداخت)"
              checked={appSetting.appTestMode}
              onChange={(e) =>
                setAppSetting((i) => ({ ...i, appTestMode: !i.appTestMode }))
              }
            />
              ...
              <Dropdown as={ButtonGroup} className="tw-w-full">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setAppSetting((x) => ({
                      ...x,
                      managerPhoneNum: [...x.managerPhoneNum, newPhoneNum]
                    }))
                    setNewPhoneNum("")
                  }}
                >
                    ...
                    >
                      ...
                      <span
                        onClick={() =>
                          setAppSetting((x) => ({
                            ...x,
                            managerPhoneNum: x.managerPhoneNum.filter(
                              (j) => j != i
                            )
                          }))
                        }
            ...
            <SettingItemCheck
              label="ارسال پیامک برای مدیران"
              checked={appSetting.doSendSmsToManager}
              onChange={(e) =>
                setAppSetting((i) => ({
                  ...i,
                  doSendSmsToManager: !i.doSendSmsToManager
                }))
              }
            />
              ...
              <Dropdown as={ButtonGroup} className="tw-w-full">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setAppSetting((x) => ({
                      ...x,
                      mangerBaleId: [...x.mangerBaleId, newBaleId]
                    }))
                    setNewBaleId("")
                  }}
                >
                    ...
                    >
                      ...
                      <span
                        onClick={() =>
                          setAppSetting((x) => ({
                            ...x,
                            mangerBaleId: x.mangerBaleId.filter((j) => j != i)
                          }))
                        }
                      >
                        <Icon
            ...
            <SettingItemCheck
              label="ارسال پیام برای مدیر در بله"
              checked={appSetting.doSendMessageToManagerInBale}
              onChange={(e) =>
                setAppSetting((i) => ({
                  ...i,
                  doSendMessageToManagerInBale: !i.doSendMessageToManagerInBale
                }))
              }
            />
            ...
            <Col md="9" className="mt-md-5">
              <textarea
                ...
                onChange={(e) =>
                  setAppSetting({
                    ...appSetting,
                    ticketTermsAndServices: e.target.value
                  })
                }
        ...
        >
          <div className="rounded-4 border bg-white p-3 d-flex flex-column">
            ...
            <Form.Control
              ...
              isInvalid={passwordChange.repeatEqualsError}
              onChange={(e) =>
                setPasswordChange((x) => ({
                  ...x,
            ...
            {passwordChange.repeatEqualsError && (
              <p className="text-danger">رمز با تکرار برابر نیست</p>
            )}
      ...
      >
        {showToast && (
          <>
            <Toast.Body className="text-white">{showToast.text}</Toast.Body>
          </>
        )}
      </Toast>
    </AdminPagesContainer>
